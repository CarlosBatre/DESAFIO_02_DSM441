...
class InsertProductActivity : AppCompatActivity() {
    ...
    private fun save() {
        ...
        if(id.isNullOrEmpty()) {
            ...
            val product = Product(generateId, name, price.toFloat(), description, stock.toInt())
            ...
            val product = Product(id, name, price.toFloat(), description, stock.toInt())
    ...
    private fun buttonsListeners() {
        ...
        btnProductClose.setOnClickListener {
            ...
            intent = Intent(this, ProductoActivity::class.java)
